...
use App\Filament\Hr\Resources\KelolaKPIResource\Pages;
...
class KelolaKPIResource extends Resource
{
                ...
                Forms\Components\Section::make('Informasi Dasar KPI')
                    ->schema([
                        Forms\Components\TextInput::make('id')
                            ->label('ID KPI (Auto-Generated)')
                            ->disabled()
                            ->dehydrated()
                            ->placeholder('Auto-generated: KPI-DIV-001-001 atau KPI-IND-EMP00001-001')
    ...
    {
        return [
            'index' => Pages\ListKelolaKPIS::route('/'),
            'create' => Pages\CreateKelolaKPI::route('/create'),
            'edit' => Pages\EditKelolaKPI::route('/{record}/edit'),
        ];
    }
