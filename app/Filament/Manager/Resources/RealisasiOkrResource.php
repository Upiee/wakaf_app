...
use App\Filament\Manager\Resources\RealisasiOkrResource\Pages;
use App\Filament\Manager\Resources\RealisasiOkrResource\RelationManagers;
...
class RealisasiOkrResource extends Resource
{
    ...
    // Query untuk hanya menampilkan OKR divisi manager yang login
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                // Tampilan informasi OKR (read-only)
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('performance_range')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        ...
                        return match($data['value']) {
                            'excellent' => $query->where('nilai', '>=', 90),
                            'good' => $query->whereBetween('nilai', [80, 89]),
                            'average' => $query->whereBetween('nilai', [70, 79]),
                            'poor' => $query->whereBetween('nilai', [60, 69]),
                            'critical' => $query->where('nilai', '<', 60),
                            default => $query,
                        };
                    })
                    ->options([
                ...
                Tables\Filters\SelectFilter::make('okr_id')
                    ...
                    ->options(function () {
                        $user = Auth::user();
                        return KelolaOKR::where('divisi_id', $user->divisi_id)
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('finalize')
                    ...
                    ->modalHeading('Finalisasi Data Realisasi OKR')
